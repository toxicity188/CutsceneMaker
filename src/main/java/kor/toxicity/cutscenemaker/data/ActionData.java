...
import kor.toxicity.cutscenemaker.action.mechanic.*;
import kor.toxicity.cutscenemaker.exception.NoActionFoundException;
...
public final class ActionData extends CutsceneData {
    ...
    static {
        ...
        actions.put("animation", ActAnimation.class);
